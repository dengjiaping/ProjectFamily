...
//    }  
    ...
    private final static String[] sFtv = {
        "0214 情人节","0308 妇女节","0312 植树节", 
        "0401 愚人节","0405 清明节", "0501*劳动节", "0601 儿童节", "0808 父亲节",
        "0910 教师节", "1001*国庆节",
        "1111 光棍节", "1224 平安夜",
        "1225 圣诞节",
    };  
...
//        "1229 华严菩萨诞", "0100*除夕"  
//    };
    private final static String[] lunarFtv = {  
        "0101*春节", "0115 元宵节",
        "0505 端午节",  
        "0707 七夕",  "0715 中元节",  
         "0815 中秋节",  
    ...
    private synchronized void findFestival() {  
        ...
        for (int i = 0; i < Lunar.lunarFtv.length; i++) {  
            m = Lunar.sFreg.matcher(Lunar.lunarFtv[i]);  
            if (m.find()) {  
     ...
     * @return 农历字符串(例:甲子年正月初三) 
     */  
    public String getLunarMontthAndDayString() {  
        return this.getLunarMonthString() 
                + this.getLunarDayString();  
    }
