...
public class ImageCache {
    ...
    private static HashMap<String, RetainFragment> mRetainManager =
    	new HashMap<String, ImageCache.RetainFragment>();
     ...
     */
    public static ImageCache getInstance(Object obj, ImageCacheParams cacheParams){
    	if (null == obj) {
			return null; 
		}
    	final String reqInterface = obj.getClass().getName();
    	RetainFragment mRetainFragment = mRetainManager.get(reqInterface);
    	if (null == mRetainFragment) {
			mRetainFragment = new RetainFragment();
			mRetainManager.put(reqInterface, mRetainFragment);
		}
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache == null || mDiskLruCache.isClosed()) {
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) { //剩余空间足够
                        try {
