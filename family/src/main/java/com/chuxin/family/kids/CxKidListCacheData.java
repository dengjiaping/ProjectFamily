...
public class CxKidListCacheData extends SQLiteOpenHelper {
	
	private static final String sDbName = "KidListCacheData";
	...
	public CxKidListCacheData(Context context, String name,
			CursorFactory factory, int version) {
		super(context, name, factory, version);		
	}
	
	public CxKidListCacheData(Context context){
...
//		uid="abc";//现在暂时默认为abc  
	 ...
	 * @return
	 */
	public CxKidFeedList queryCacheData(String uid){
...
//		RkLog.i("men", feedsStr);
		CxKidParser cacheDataParser = new CxKidParser();
		CxKidFeedList list = null;
		try {			
			list = cacheDataParser.getKidHomeList(-1, new JSONObject(feedsStr), context);
		} catch (Exception e) {
		}
		return list;
	}
