...
// *
// */
//public class CxAnswerFragment extends Fragment {
//
//	
...
//						Intent intent=new Intent(getActivity(), CxAnswerUpActivity.class);
...
//						getActivity().overridePendingTransition(R.anim.scale_next_in, R.anim.scale_next_out);
//					}					
//					break;
//				default:
//					break;
...
//		
//		View inflate = inflater.inflate(R.layout.cx_fa_activity_neighbour_answer_homepage, null);
//		
//		initTitle(inflate);
//		init(inflate);
//		
...
//		
//		if(wifePercent==0){
//			wifePixel=ScreenUtil.dip2px(getActivity(), 10);
//			husbandPixel=LayoutParams.MATCH_PARENT;
//		}else if(husbandPercent==0){
//			husbandPixel=ScreenUtil.dip2px(getActivity(), 10);
...
//			wifePixel=ScreenUtil.dip2px(getActivity(), 80*wifePercent);
//			husbandPixel=ScreenUtil.dip2px(getActivity(), 80*husbandPercent);
//		}
//		
//		int heightPixel=ScreenUtil.dip2px(getActivity(), 8);
//		
...
//			
//			View view = View.inflate(getActivity(), R.layout.cx_fa_activity_neighbour_answer_homepage_item, null);
//			
...
//		ImageView backImg = (ImageView) view.findViewById(R.id.cx_fa_answer_home_title_back_iv);
//		totalText = (TextView) view.findViewById(R.id.cx_fa_answer_home_title_total_tv);
//		ratioText = (TextView) view.findViewById(R.id.cx_fa_answer_home_title_ratio_tv);
//		girlRatioImg = (ImageView) view.findViewById(R.id.cx_fa_answer_home_title_girl_ratio_iv);
//		boyRatioImg = (ImageView) view.findViewById(R.id.cx_fa_answer_home_title_boy_ratio_iv);
//		girlIconImg = (CxImageView) view.findViewById(R.id.cx_fa_answer_home_title_girl_icon_iv);
//		boyIconImg = (CxImageView) view.findViewById(R.id.cx_fa_answer_home_title_boy_icon_iv);
//				
...
//		
//		startAnswer = (Button) view.findViewById(R.id.cx_fa_answer_home_start_btn);
//		leaveText = (TextView) view.findViewById(R.id.cx_fa_answer_home_leave_tv);
//		
//		weekRankLayout = (LinearLayout) view.findViewById(R.id.cx_fa_answer_home_week_rank_layout);
//		totalRankLayout = (LinearLayout) view.findViewById(R.id.cx_fa_answer_home_total_rank_layout);
//		ratioRankLayout = (LinearLayout)view.findViewById(R.id.cx_fa_answer_home_ratio_rank_layout);
//		weekRankText = (TextView) view.findViewById(R.id.cx_fa_answer_home_week_rank_tv);
//		totalRankText = (TextView) view.findViewById(R.id.cx_fa_answer_home_total_rank_tv);
//		ratioRankText = (TextView) view.findViewById(R.id.cx_fa_answer_home_ratio_rank_tv);
//		
//		itemLayout = (LinearLayout) view.findViewById(R.id.cx_fa_answer_home_neighbour_items_layout);
//		
...
//		super.onResume();
//		CxAnswerApi.getInstance().requestAnswerHome(0, 100, homeCaller, getActivity());
//	}
//
//
//	protected void back() {
...
//		
//		if(!isNetWork){
//			ToastUtil.getSimpleToast(getActivity(), -3, getString(R.string.cx_fa_answer_home_net_fail_2), 1).show();
//			return ;
//		}
//		
//		if(isAlone){
...
//				}
//			});
//			du.getSimpleDialog(getActivity(), null, getString(R.string.cx_fa_answer_home_alone_add_neighbour_text), 
//					getString(R.string.cx_fa_answer_home_alone_add_neighbour), null).show();;
//			return;
//		}
//		
//		if(isOver){
//			ToastUtil.getSimpleToast(getActivity(), -3, getString(R.string.cx_fa_answer_home_today_remain_over_toast), 1).show();
//			return ;
//		}
//		
//		Intent intent=new Intent(getActivity(), CxAnswerQuestionActivity.class);
//		startActivity(intent);
//		getActivity().overridePendingTransition(R.anim.tran_next_in, R.anim.tran_next_out);
//			
...
//					showResponseToast(getActivity().getString(R.string.cx_fa_net_response_code_fail),0);
//				}else{
