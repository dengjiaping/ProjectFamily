...
//    	RkLog.i("SlidingDrawer", "isContentTouch method");
...
//    	RkLog.i("SlidingDrawer", " onDownAllowDrag running");
        switch (mPosition) {
            case LEFT:
...
//    	RkLog.i("SlidingDrawer", " onMoveAllowDrag running");
        switch (mPosition) {
            case LEFT:
...
//    	RkLog.i("SlidingDrawer", " onMoveEvent running");
        switch (mPosition) {
            case LEFT:
...
//    	RkLog.i("SlidingDrawer", " onUpEvent running");
        final int offsetPixels = (int) mOffsetPixels;
...
//    		RkLog.i("SlidingDrawer", "onInterceptTouchEvent return false because RecorderFlag is true");
			return false;
		}
    ...
    public boolean onTouchEvent(MotionEvent ev) {
    	if (CxGlobalParams.getInstance().isRecorderFlag()) {
//    		RkLog.i("SlidingDrawer", "onTouchEvent method return false because RecorderFlag is true");
			return false;
		}
